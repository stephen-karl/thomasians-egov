  ...
  return (
    <article className="flex items-center justify-start gap-6">
        ...
        <div className="flex flex-col items-center justify-center object-cover w-full h-full">
          {value ? (
            ...
            <div className="flex items-center justify-center">
              <ImageIcon className="w-8 h-8 stroke-1  fill-gray-200" />
            </div>
          )}
          <input
            type="file"
      ...
      <section className="flex flex-col gap-2">
        ...
        <p className="text-sm text-gray-500 w-full">An actual image of the 
          <span className="text-fiery font-semibold">{" "}person.</span> It's best if it has the same height and width.</p>
      </section>
    </article>
  );
});
